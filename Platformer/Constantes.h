...
// Pour une plateforme de 5 pixels de haut sur 5 pixels de large
const int OVER_CENTER_X_PLATFORM = 3;
const int OVER_CENTER_Y_PLATFORM = 3;
const int WIDTH_PLATFORM = 5;
